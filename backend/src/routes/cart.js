...
router.get('/api/cart', validateSession, ar(async (req, res) => {
...
router.post('/api/cart/items', validateSession, ar(async (req, res, next) => {
...
router.patch('/api/cart/items/:menuItemId', validateSession, ar(async (req, res, next) => {
...
router.delete('/api/cart/items/:menuItemId', validateSession, ar(async (req, res) => {
